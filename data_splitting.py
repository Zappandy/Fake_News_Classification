...
datasets[0].reset_index(inplace=True)
datasets[1].reset_index(inplace=True)
datasets[2].reset_index(inplace=True)
datasets[3].reset_index(inplace=True)
datasets[4].reset_index(inplace=True)
datasets[5].reset_index(inplace=True)
datasets = [data.pop("index") for data in datasets]
